...
public class Role extends TableImpl<RoleRecord> {
    ...
    private static final long serialVersionUID = 1935840484;

    /**
     * The reference instance of <code>super.role</code>
     */
    ...
    /**
     * The column <code>super.role.id</code>. 角色id
     */
    ...
    /**
     * The column <code>super.role.name</code>. 角色名称
     */
    ...
    /**
     * The column <code>super.role.department_id</code>. 部门id
     */
    public final TableField<RoleRecord, Integer> DEPARTMENT_ID = createField("department_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "部门id");

    /**
     * The column <code>super.role.enabled</code>.
     */
    ...
    /**
     * The column <code>super.role.created_at</code>.
     */
    public final TableField<RoleRecord, Timestamp> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>super.role.updated_at</code>.
     */
    public final TableField<RoleRecord, Timestamp> UPDATED_AT = createField("updated_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * Create a <code>super.role</code> table reference
     */
    public Role() {
    ...
    /**
     * Create an aliased <code>super.role</code> table reference
     */
